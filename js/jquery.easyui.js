    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        loader : function (_7db, _7dc, _7dd) {
            ...
            $.ajax({
                ...
                success : function (data) {
                    var res = {};
                    if (opts.url.indexOf("api/permissions/parents") != -1) {
                        res.rows = data.data;
                    }
                    else if (opts.url.indexOf("api/permissions/getchild") != -1) {
                        res.rows = data.data;
                    }
                    else {
                        res.rows = data.data.data;
                        res.pageNumber = data.data.pageNum;
                        res.pageSize = data.data.pageSize;
                        res.totalPage = data.data.pages;
